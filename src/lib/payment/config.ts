...
export function getPaymentConfig(): PaymentConfig {
  ...
  if (paymentEnv === 'production') {
    return {
      ...
      paymentUrl: process.env.CREEM_PROD_PAYMENT_URL || process.env.CREEM_PAYMENT_URL || 'https://www.creem.io/payment',
  ...
  return {
    ...
    paymentUrl: process.env.CREEM_TEST_PAYMENT_URL || process.env.CREEM_PAYMENT_URL || 'https://www.creem.io/test/payment',
    webhookSecret: process.env.CREEM_WEBHOOK_SECRET || '',
  };
}
