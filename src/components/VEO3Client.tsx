...
export default function VEO3Client() {
  ...
  const [provider] = useState<'veo3'>('veo3');
  ...
  // Get a random demo video from templates
  const [demoVideo, setDemoVideo] = useState(asmrTemplates[0]);
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-white/20 mt-8">
            ...
            <div className="grid md:grid-cols-3 gap-8" data-aos="fade-up" data-aos-delay="200">
              {asmrTemplates.slice(0, 3).map((template, index) => (
                <div key={template.id} className="bg-white/10 backdrop-blur-sm rounded-xl overflow-hidden border border-white/20 hover:border-purple-400/50 transition-all duration-300 hover:transform hover:scale-105">
